...
, function(t, e, n) {
    ...
    function d(t, e, n, o, r) {
        ...
        "key" === e)
            ...
            if ("style" === e) {
                ...
                o ? n || t.addEventListener(e, m, a) : t.removeEventListener(e, m, a),
    ...
    function v(t, e, n, o, r, i) {
        q++ || (H = null != r && void 0 !== r.ownerSVGElement,
    ...
    function g(t, e, n, o, r) {
        ...
        "string" == typeof e || "number" == typeof e)
            return t && void 0 !== t.splitText && t.parentNode && (!t._component || r) ? t.nodeValue != e && (t.nodeValue = e) : (i = document.createTextNode(e),
        ...
        return !z && l && 1 === l.length && "string" == typeof l[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != l[0] && (c.nodeValue = l[0]) : (l && l.length || null != c) && y(i, l, n, o, z || null != p.dangerouslySetInnerHTML),
        _(i, e.attributes, p),
        H = a,
        i
    }
    function y(t, e, n, o, r) {
        ...
        if (0 !== v)
            for (var _ = 0; v > _; _++) {
                ...
                null != j ? (m++,
                h[j] = O) : (C || (void 0 !== O.splitText ? !r || O.nodeValue.trim() : r)) && (d[y++] = O)
            }
        if (0 !== x)
            for (var _ = 0; x > _; _++) {
                u = e[_],
                ...
                p = g(p, u, n, o),
                s = f[_],
                p && p !== t && p !== s && (null == s ? t.appendChild(p) : p === s.nextSibling ? l(s) : t.insertBefore(p, s))
            }
        if (m)
            for (var _ in h)
                void 0 !== h[_] && w(h[_], !1);
    ...
    function w(t, e) {
        var n = t._component;
        n ? B(n) : (null != t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null),
    ...
    function C(t, e, n) {
        var o, r = W[t.name];
        if (t.prototype && t.prototype.render ? (o = new t(e,n),
        N.call(o, e, n)) : (o = new N(e,n),
        o.constructor = t,
        o.render = j),
        r)
        ...
        if (!t._disable) {
            ...
            !_) {
                ...
                if ("function" == typeof E) {
                    var N = p(r);
                    a = x,
                    a && a.constructor === E && N.key == a.__key ? k(a, N, 1, f, !1) : (O = a,
            ...
            if (!m || n ? L.unshift(t) : _ || (t.componentDidUpdate && t.componentDidUpdate(l, d, h),
    ...
    function E(t, e, n, o) {
        ...
        return r && c && (!o || r._component) ? (k(r, u, 3, n, o),
        t = r.base) : (i && !s && (B(i),
        t = a = null),
        r = C(e.nodeName, u, n),
        t && !r.nextBase && (r.nextBase = t,
        a = null),
        k(r, u, 1, n, o),
        t = r.base,
    ...
    function B(t) {
        ...
        t.base = null;
        var n = t._component;
        n ? B(n) : e && (e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null),
        t.nextBase = e,
        l(e),
        O(t),
        x(e)),
    ...
    var r = n(0)
      ...
      , s = {
        ...
        transformRequest: [function(t, e) {
            ...
            "" + t) : r.isObject(t) ? (o(e, "application/json;charset=utf-8"),
            JSON.stringify(t)) : t
        }
        ],
...
, function(t) {
    ...
    function n(t) {
        for (var n, r, i = t + "", a = "", s = 0, c = o; i.charAt(0 | s) || (c = "=",
...
, function(t, e, n) {
    ...
    e.a = function(t) {
        ...
        e.prototype.render = function(t, e) {
            ...
            n.wrapperHeight = h;
            var m;
            return m = r || !o && !n.alwaysUseFloatingButton ? o ? f.h : (r || this.state.wasChatOpened) && r ? d({}, f.e, l) : d({}, f.c) : d({}, f.g),
            Object(i.b)("div", {
                style: m
...
, function(t, e, n) {
    ...
    var o = {
        ...
        // chatServer: "https://caresbot.darksensation.in/public/botman",
        frameEndpoint: "http://127.0.0.1:8000/botman/chat",
        // frameEndpoint: "https://caresbot.darksensation.in/public/botman/chat",
        // frameEndpoint: "/botman/chat",
        timeFormat: "HH:MM",
        dateTimeFormat: "m/d/yy HH:MM",
        title: "CARES-Goa",
        cookieValidInDays: 1,
        introMessage: "CARES-Goa Welcomes you..😊 <br> Please type 'hi' or 'hello' to begin the conversation...",
        ...
        // mainColor: "#6C4AB6",
        mainColor: `linear-gradient(to bottom right, rgba(100,63,236), rgba(181,56,247))`,
        headerTextColor: "#fff",
