...
<body>
    ...
    {{-- <div class="d-grid gap-2 d-md-flex justify-content-md-start"> --}}
       <a href="{{url('manage-question/'.$data->subtopic_id)}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>&nbsp;&nbsp;&nbsp;
       <a href="{{url('edit-question/'.$data->question_id)}}" class="btn btn-primary ">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <br><br>
