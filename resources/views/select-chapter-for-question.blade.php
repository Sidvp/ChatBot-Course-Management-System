...
<div class="container" >
    <div class="row">
        <div class="col-md-12 mx-auto">
            <form method="post" action="{{url('identify-chapter-for-question')}}">
                @csrf
            <div class="form-group mt-4 card p-3 bg-white">
                ...
                <div class="form-group mx-auto">
                    <br>
                    <a href="{{url('/select-course-for-question')}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>
