...
<body class="bg-dark">
  ...
  @include('header');  <!-- View -->
    ...
    <div class="container">
        ...
        <form method="post" action="{{url('update-course')}}">
            @csrf
            {{-- pass id --}}
            ...
            <div class="form-group mt-4 card p-3 bg-white">
                    ...
                    <br>
                <h2 class="text-center text-primary">Edit Course</h2><br><br>
                      ...
                      {{-- <input type="hidden" name="course_id" value="{{$data->course_id}}"> --}}
                        ...
                        {{-- <div class="dropdown">
                          ...
                          <select class="form-control required" name="class" id="class" style="">
                            ...
                            <option value="VI" @if ($data->class == "VI") {{ 'selected' }} @endif>VI</option>
                            <option value="VII" @if ($data->class == "VII") {{ 'selected' }} @endif>VII</option>
                            <option value="VIII" @if ($data->class == "VIII") {{ 'selected' }} @endif>VIII</option>
                          </select>
                          <br>
                    ...
                    <div class="input-group">
                      ...
                      {{-- <div class="dropdown">
                        ...
                        <select class="form-control required" name="curriculum" id="curriculum" style="">
                          ...
                          <option value="REGULAR" @if ($data->curriculum == "REGULAR") {{ 'selected' }} @endif>REGULAR</option>
                          <option value="ELECTIVE" @if ($data->curriculum == "ELECTIVE") {{ 'selected' }} @endif>ELECTIVE</option>
                        </select>
                      <br>
                ...
                <div class="form group mx-auto">
                    <br>
                    <a href="{{url('/manage-course')}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>
