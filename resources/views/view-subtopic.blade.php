        ...
        <div class="col-md-12 mx-auto">
                ...
                <tbody>
                    ...
                    @foreach ($subtopics as $index => $subtopic)
                        <tr>
                            ...
                            <td><a href="{{url('show-details-subtopic1/'.$subtopic->subtopic_id)}}" class="btn btn-secondary ">Show Details</a></td>
                        </tr>         
                    @endforeach 
                </tbody>
            </table>  
            {{-- <div class="row">
             ...
             <div class="form group mx-auto">
                <br>
                <a href="{{url('selected-chapter-for-subtopic')}}"><button class="btn btn-primary me-md-2" type="button">Back</button></a>
            </div>
