...
<body class="bg-dark">
    ...
    <div class="container" style="margin-bottom: 40px;">
        ...
        <form action="{{url('save-question')}}" method="POST">
                    ...
                    <div class="form group col-md-10 required mx-auto">
                        ...
                        <div>
                            ...
                            <select name="question_type" id="question_type" required style="width:180px; height:30px;">
                                ...
                                <option value="mcq2" @if (old('question_type') == "mcq2") {{ 'selected' }} @endif>2 Options MCQ</option>
                                <option value="mcq4" @if (old('question_type') == "mcq4") {{ 'selected' }} @endif>4 Options MCQ</option>
                                <option value="chk2" @if (old('question_type') == "chk2") {{ 'selected' }} @endif>2 Options Checkboxes</option>
                                <option value="chk4" @if (old('question_type') == "chk4") {{ 'selected' }} @endif>4 Options Checkboxes</option>
                                <option value="fillBlank" @if (old('question_type') == "fillBlank") {{ 'selected' }} @endif>Fill in the blanks</option>
                                {{-- <option value="img">Image Choice</option> --}}
                                <option value="shortAns" @if (old('question_type') == "shortAns") {{ 'selected' }} @endif>Short Answer</option>
                                <option value="longAns" @if (old('question_type') == "longAns") {{ 'selected' }} @endif>Long Answer</option>
                        ...
                        <div class="questionbox col-md-8">
                            ...
                            <label for="" id="difficulty_level1" class="form-label" style="display:none">Difficulty Level</label>
                                <select type="" id="difficulty_level" name="difficulty_level" required placeholder="Select Level of Difficulty" style="height:30px;dispaly:none">
                                    ...
                                    <option value="Difficult" @if (old('difficulty_level') == "Difficult") {{ 'selected' }} @endif>Difficult</option>
                                </select>
                            ...
                            <input type="number" id="quest_order" name="quest_order" placeholder="Enter Question Order" style="width:500px;display:none">
                            <span class="text-danger">
                                @error('quest_order')
                                    {{$message}}
                                @enderror
                            ...
                            <input type="text" id="quest_img" name="quest_img" placeholder="Enter Image Link " style="width:500px;display:none">
                            <span class="text-danger">
                                @error('quest_img')
                                    {{$message}}
                                @enderror
                            ...
                            <div id="mcq2" class="qt" style="display: none">
                                ...
                                <select type="number" name="correctOpt2" placeholder="Enter Correct Option No." style="height:30px">
                                    ...
                                    <option value="1" @if (old('correctOpt2') == "1") {{ 'selected' }} @endif>1</option>
                                    <option value="2" @if (old('correctOpt2') == "2") {{ 'selected' }} @endif>2</option>
                                </select>
                                @error('correctOpt2')
                                    {{$message}}
                                @enderror
                            ...
                            <div id="mcq4" class="qt" style="display: none">
                                ...
                                <select type="number" name="correctOpt4" placeholder="Enter Correct Option No." style="height:30px">
                                    <option selected disabled value="">Select Correct Option  </option>
                                    <option value="1" @if (old('correctOpt4') == "1") {{ 'selected' }} @endif>1</option>
                                    <option value="2" @if (old('correctOpt4') == "2") {{ 'selected' }} @endif>2</option>
                                    <option value="3" @if (old('correctOpt4') == "3") {{ 'selected' }} @endif>3</option>
                                    <option value="4" @if (old('correctOpt4') == "4") {{ 'selected' }} @endif>4</option>
                                </select>
                                @error('correctOpt4')
                                    {{$message}}
                                @enderror
                            ...
                            <div id="chk2" class="qt" style="display: none">
                                ...
                                <select id="correctchkopt2" name="correctchkopt2[]" class="form-select w-25" style="height:45px; text-align: center; font-size:14px;" multiple>
                                    ...
                                    <option value="2" @if (old('correctchkopt2') == "2") {{ 'selected' }} @endif>2</option>
                                </select>
                            ...
                            <div id="chk4" class="qt" style="display: none">
                                ...
                                <select id="correctchkopt4" name="correctchkopt4[]" class="form-select w-25" style="height:80px; text-align: center; font-size:14px;" multiple>
                                    <option value="1" @if (old('correctchkopt4') == "1") {{ 'selected' }} @endif>1</option>
                                    <option value="2" @if (old('correctchkopt4') == "2") {{ 'selected' }} @endif>2</option>
                                    <option value="3" @if (old('correctchkopt4') == "3") {{ 'selected' }} @endif>3</option>
                                    <option value="4" @if (old('correctchkopt4') == "4") {{ 'selected' }} @endif>4</option>
                                </select>
