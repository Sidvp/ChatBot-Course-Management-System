...
<body>
    ...
    {{-- <div class="d-grid gap-2 d-md-flex justify-content-md-start"> --}}
       <a href="{{url('view-subtopics/'.$data->chapter_id)}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>&nbsp;&nbsp;&nbsp;
       <a href="{{url('edit-subtopic1/'.$data->subtopic_id)}}" class="btn btn-primary ">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
