        ...
        <div class="col-md-12 mx-auto">
                ...
                <tbody>
                    ...
                    @foreach ($questions as $index => $question)
                        <tr>
                            ...
                            <td><a href="{{url('show-details/'.$question->question_id)}}" class="btn btn-secondary ">Show Details</a> &nbsp;&nbsp;&nbsp;<a href="{{url('edit-question/'.$question->question_id)}}" class="btn btn-primary ">Edit</a>&nbsp;&nbsp;&nbsp;<a href="{{url('delete-question/'.$question->question_id)}}" class="btn btn-danger">Delete</a> </td>
                        </tr>         
                    @endforeach 
                </tbody>
            </table>  
            {{-- <div class="row">
             ...
             <div class="form group mx-auto">
                <br>
                <a href="{{url('select-subtopic-for-question')}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>
            </div>
