...
<div class="container" >
    <div class="row">
        <div class="col-md-12 mx-auto">
            <form method="post" action="{{url('identified-subtopic-for-question')}}">
                @csrf
            <div class="form-group mt-4 card p-3 bg-white">
         
                <h2 class="text-center">Select Subtopic</h2> <br>  
                ...
                <select class="form-control required" name="subtopic_name" id="class" style="margin: auto; width:1000px;">
                    <option selected disabled value="">Select Subtopic</option>
                    
                    @foreach ($subtopics as $subtopic)

                    <option value="{{ $subtopic['subtopic_name'] }}">{{ $subtopic['subtopic_name'] }}</option>
                ...
                <div class="form-group mx-auto">
                    <br>
                    <a href="{{url('/selected-chapter-for-question')}}"><button class="btn btn-danger me-md-2" type="button">Back</button></a>
