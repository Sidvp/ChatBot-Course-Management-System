    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="{{url('add-chapter/'.$course->course_id)}}" ><button class="btn btn-primary me-md-2" type="button">Add Chapter</button></a><br><br><br>
                </div>
            ...
            {{-- <div class="row">
             ...
             <div class="form group mx-auto">
                <br>
                <a href="{{url('select-course')}}"><button class="btn btn-primary me-md-2" type="button">Back</button></a>
            </div>
